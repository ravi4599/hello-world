package com.virginvoyages.shoretoship
...
//    
//    val props = new Properties()
//    props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG,"10.9.100.157:9097,10.9.100.142:9097,10.9.100.37:9097")
//    props.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, classOf[StringSerializer])
//    props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, classOf[StringSerializer])
//    props.put(CommonClientConfigs.SECURITY_PROTOCOL_CONFIG, "SSL")
//    props.put(SslConfigs.SSL_TRUSTSTORE_LOCATION_CONFIG,"/etc/script_keystore/dxp.kafka.client.truststore.jks")
//    props.put(SslConfigs.SSL_TRUSTSTORE_PASSWORD_CONFIG,"SetS@!l2o2o")
//    props.put(SslConfigs.SSL_KEYSTORE_LOCATION_CONFIG,"/etc/script_keystore/dxp.kafka.client.keystore.jks")
//    props.put(SslConfigs.SSL_KEYSTORE_PASSWORD_CONFIG,"SetS@!l2o2o")
//    props.put(SslConfigs.SSL_KEY_PASSWORD_CONFIG,"SetS@!l2o2o")
//    
//    val producer = new KafkaProducer[String, String](props)
//    
//    producer
