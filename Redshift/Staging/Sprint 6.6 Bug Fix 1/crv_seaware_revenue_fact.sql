CREATE OR replace VIEW seaware.seaware_revenue_fact AS SELECT snapshot_date, 
       ...
       (actual_gross_ticket_revenue+actual_gross_other_revenue+actual_gross_onboard_revenue) AS actual_gross_total_revenue, --(nvl(VOYAGE_AMOUNT,0)+nvl(TAXESandFEES,0)-nvl(VOYAGE_COMMISSION_AMT,0)- (VOYAGE_CREDIT_CARD_FEE+INSURANCE_CREDIT_CARD_FEE+TAXESandFEES_CREDIT_CARD_FEE )) AS ACTUAL_NET_NET_TICKET_REVENUE,
