drop table hive_schema_stg.seaware_sail_cabin_fact;
...
ALTER TABLE hive_schema_stg.seaware_sail_cabin_fact ADD IF NOT EXISTS  PARTITION (snapshot_date = '2020-02-18') location 's3://vv-qa-emr-cluster/data/core/seaware/hvtb_nbx_core_sw_sail_cabin_fact/snapshot_date=2020-02-18';