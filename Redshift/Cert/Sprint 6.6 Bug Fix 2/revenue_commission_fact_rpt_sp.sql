...
BEGIN
delete from  seaware.revenue_commission_fact_rpt;
...
select
  ...
  , seaware_reservation_dim.res_init_date  
  , seaware_reservation_dim.source_code 
  , seaware_guest_dim.src_guest_id  
