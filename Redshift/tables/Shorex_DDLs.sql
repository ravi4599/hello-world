drop table if exists hive_schema_stg.hvtb_nbx_landing_sw_rpl_package_itinerary;
...
LOCATION
  's3://vv-prod-emr-cluster/data/landing/spf/hvtb_nbx_landing_seaware_rpl_package_itinerary';

drop table if exists hive_schema_stg.hvtb_nbx_landing_sw_rpl_package_type_vendor_link;  
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  's3://vv-prod-emr-cluster/data/landing/spf/hvtb_nbx_landing_seaware_rpl_package_type_vendor_link';

drop table if exists hive_schema_stg.hvtb_nbx_landing_sw_rpl_vendor;
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  's3://vv-prod-emr-cluster/data/landing/spf/hvtb_nbx_landing_seaware_rpl_vendor';

drop table if exists hive_schema_stg.hvtb_nbx_landing_sw_rpl_package_type;  
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  's3://vv-prod-emr-cluster/data/landing/spf/hvtb_nbx_landing_seaware_rpl_package_type'
;
