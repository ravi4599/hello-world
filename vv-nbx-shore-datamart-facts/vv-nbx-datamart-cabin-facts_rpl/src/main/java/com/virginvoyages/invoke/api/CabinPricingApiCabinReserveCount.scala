...
object CabinPricingApiCabinReserveCount {
  ...
  def main(args: Array[String]): Unit = {
    ...
    var inputDf = sparkSession.sql(query)
    //inputDf.show()
...
.withColumn("is_active", stage_final_df2.col("is_active"))
 ...
 sailcabindetailfactfinalDF = sailcabindetailfactfinalDF.select("sail_id", "cabin_category", "cabin_category_rank", "capacity", "max_capacity", "num_of_cabins", "ok_abs", "ok_wgt", "gty_abs", "gty_wgt", "wtl_abs", "wtl_wgt", "avail_cabins", "avail_abs", "avail_wgt", "avail_nested", "num_of_reserved", "in_allotments", "nofupgrades", "num_of_upgrade", "num_of_downgrade", "shared_abs", "shared_allotment_abs","na_abs", "ok_gty_rstr_abs","ship_code","type","is_active")
		...
		//	var  tgttable_CAPACITY_count = tgttable_CAPACITY.count
			...
			left join vv_db_mig.hvtb_nbx_core_sw_sail_dim sd on sd.src_sail_id = c.sail_id and sd.rec_end_dttm like '999%' 
			...
			var insert_hive_qry_dtl_scf = "INSERT overwrite TABLE vv_db_mig.hvtb_nbx_staging_sw_sail_cabin_fact SELECT c.snapshot_time ,sd.sail_id ,c.cabin_category ,c.cabin_category_rank ,c.generic_category ,c.max_capacity ,c.num_of_cabins ,c.ok_abs ,c.ok_wgt ,c.gty_abs ,c.gty_wgt ,c.wtl_abs ,c.wtl_wgt ,c.avail_cabins ,c.avail_abs ,c.avail_wgt ,c.avail_nested ,c.num_of_reserved ,c.in_allotments ,c.num_of_upgrade ,c.num_of_downgrade ,c.shared_abs ,c.shared_allotment_abs ,c.etl_ld_dt ,c.etl_upd_dt ,c.na_abs ,c.ok_gty_rstr_abs AS ok_gtry_rstr_abs ,sailapi1.taxes_and_fees AS taxes_and_fees ,sailapi1.voyage_fare_guest1 AS voyage_fare_guest1 ,sailapi1.voyage_fare_guest2 AS voyage_fare_guest2 ,sailapi1.voyage_fare_guest3 AS voyage_fare_guest3 ,sailapi1.voyage_fare_guest4 AS voyage_fare_guest4 ,sailapi1.discount_guest1 ,sailapi1.discount_guest2 ,sailapi1.discount_guest3 ,sailapi1.discount_guest4 ,sailapi1.voyage_fare_guest1_gbp ,sailapi1.voyage_fare_guest2_gbp ,sailapi1.voyage_fare_guest3_gbp ,sailapi1.voyage_fare_guest4_gbp ,sailapi1.discount_guest1_gbp ,sailapi1.discount_guest2_gbp ,sailapi1.discount_guest3_gbp ,sailapi1.discount_guest4_gbp ,sailapi1.taxes_and_fees_gbp ,sailapi1.voyage_fare_guest1_aud ,sailapi1.voyage_fare_guest2_aud ,sailapi1.voyage_fare_guest3_aud ,sailapi1.voyage_fare_guest4_aud ,sailapi1.discount_guest1_aud ,sailapi1.discount_guest2_aud ,sailapi1.discount_guest3_aud ,sailapi1.discount_guest4_aud ,sailapi1.taxes_and_fees_aud ,sailapi1.voyage_fare_guest1_cad ,sailapi1.voyage_fare_guest2_cad ,sailapi1.voyage_fare_guest3_cad ,sailapi1.voyage_fare_guest4_cad ,sailapi1.discount_guest1_cad ,sailapi1.discount_guest2_cad ,sailapi1.discount_guest3_cad ,sailapi1.discount_guest4_cad ,sailapi1.taxes_and_fees_cad ,c.snapshot_date FROM tgttable_CATEGORYtbl c LEFT JOIN vv_db_mig.hvtb_nbx_core_sw_sail_dim sd ON sd.src_sail_id = c.sail_id AND sd.rec_end_dttm LIKE '999%' LEFT JOIN ( SELECT sailapi.prc_sail_id ,sailapi.prc_category ,sum(sailapi.taxes_and_fees) AS taxes_and_fees ,sum(sailapi.voyage_fare_guest1) AS voyage_fare_guest1 ,sum(sailapi.voyage_fare_guest2) AS voyage_fare_guest2 ,sum(sailapi.voyage_fare_guest3) AS voyage_fare_guest3 ,sum(sailapi.voyage_fare_guest4) AS voyage_fare_guest4 ,sum(sailapi.DISCOUNT_GUEST1) AS DISCOUNT_GUEST1 ,sum(sailapi.DISCOUNT_GUESt2) AS DISCOUNT_GUEST2 ,sum(sailapi.DISCOUNT_GUEST3) AS DISCOUNT_GUEST3 ,sum(sailapi.DISCOUNT_GUEST4) AS DISCOUNT_GUEST4 ,sum(sailapi.taxes_and_fees_gbp) AS taxes_and_fees_gbp ,sum(sailapi.voyage_fare_guest1_gbp) AS voyage_fare_guest1_gbp ,sum(sailapi.voyage_fare_guest2_gbp) AS voyage_fare_guest2_gbp ,sum(sailapi.voyage_fare_guest3_gbp) AS voyage_fare_guest3_gbp ,sum(sailapi.voyage_fare_guest4_gbp) AS voyage_fare_guest4_gbp ,sum(sailapi.DISCOUNT_GUEST1_gbp) AS DISCOUNT_GUEST1_gbp ,sum(sailapi.DISCOUNT_GUEST2_gbp) AS DISCOUNT_GUEST2_gbp ,sum(sailapi.DISCOUNT_GUEST3_gbp) AS DISCOUNT_GUEST3_gbp ,sum(sailapi.DISCOUNT_GUEST4_gbp) AS DISCOUNT_GUEST4_gbp ,sum(sailapi.taxes_and_fees_aud) AS taxes_and_fees_aud ,sum(sailapi.voyage_fare_guest1_aud) AS voyage_fare_guest1_aud ,sum(sailapi.voyage_fare_guest2_aud) AS voyage_fare_guest2_aud ,sum(sailapi.voyage_fare_guest3_aud) AS voyage_fare_guest3_aud ,sum(sailapi.voyage_fare_guest4_aud) AS voyage_fare_guest4_aud ,sum(sailapi.DISCOUNT_GUEST1_aud) AS DISCOUNT_GUEST1_aud ,sum(sailapi.DISCOUNT_GUEST2_aud) AS DISCOUNT_GUEST2_aud ,sum(sailapi.DISCOUNT_GUEST3_aud) AS DISCOUNT_GUEST3_aud ,sum(sailapi.DISCOUNT_GUEST4_aud) AS DISCOUNT_GUEST4_aud ,sum(sailapi.taxes_and_fees_cad) AS taxes_and_fees_cad ,sum(sailapi.voyage_fare_guest1_cad) AS voyage_fare_guest1_cad ,sum(sailapi.voyage_fare_guest2_cad) AS voyage_fare_guest2_cad ,sum(sailapi.voyage_fare_guest3_cad) AS voyage_fare_guest3_cad ,sum(sailapi.voyage_fare_guest4_cad) AS voyage_fare_guest4_cad ,sum(sailapi.DISCOUNT_GUEST1_cad) AS DISCOUNT_GUEST1_cad ,sum(sailapi.DISCOUNT_GUEST2_cad) AS DISCOUNT_GUEST2_cad ,sum(sailapi.DISCOUNT_GUEST3_cad) AS DISCOUNT_GUEST3_cad ,sum(sailapi.DISCOUNT_GUEST4_cad) AS DISCOUNT_GUEST4_cad FROM ( SELECT prc.sail_id AS prc_sail_id ,prc.category AS prc_category ,CASE WHEN prc.price_code = 'TAXES_FEES' AND currency = 'USD' THEN prc.amount ELSE 0 END AS taxes_and_fees ,CASE WHEN prc.price_code = 'VOYAGE_FARE' AND currency = 'USD' AND prc.guestseq = 1 THEN prc.amount ELSE 0 END AS voyage_fare_guest1 ,CASE WHEN prc.price_code = 'VOYAGE_FARE' AND currency = 'USD' AND prc.guestseq = 2 THEN prc.amount ELSE 0 END AS voyage_fare_guest2 ,CASE WHEN prc.price_code = 'VOYAGE_FARE' AND currency = 'USD' AND prc.guestseq = 3 THEN prc.amount ELSE 0 END AS voyage_fare_guest3 ,CASE WHEN prc.price_code = 'VOYAGE_FARE' AND currency = 'USD' AND prc.guestseq = 4 THEN prc.amount ELSE 0 END AS voyage_fare_guest4 ,CASE WHEN prc.price_code = 'DISCOUNT' AND currency = 'USD' AND prc.guestseq = 1 THEN prc.amount ELSE 0 END AS DISCOUNT_GUEST1 ,CASE WHEN prc.price_code = 'DISCOUNT' AND currency = 'USD' AND prc.guestseq = 2 THEN prc.amount ELSE 0 END AS DISCOUNT_GUEST2 ,CASE WHEN prc.price_code = 'DISCOUNT' AND currency = 'USD' AND prc.guestseq = 3 THEN prc.amount ELSE 0 END AS DISCOUNT_GUEST3 ,CASE WHEN prc.price_code = 'DISCOUNT' AND currency = 'USD' AND prc.guestseq = 4 THEN prc.amount ELSE 0 END AS DISCOUNT_GUEST4 ,CASE WHEN prc.price_code = 'TAXES_FEES' AND currency = 'GBP' THEN prc.amount ELSE 0 END AS taxes_and_fees_gbp ,CASE WHEN prc.price_code = 'VOYAGE_FARE' AND currency = 'GBP' AND prc.guestseq = 1 THEN prc.amount ELSE 0 END AS voyage_fare_guest1_gbp ,CASE WHEN prc.price_code = 'VOYAGE_FARE' AND currency = 'GBP' AND prc.guestseq = 2 THEN prc.amount ELSE 0 END AS voyage_fare_guest2_gbp ,CASE WHEN prc.price_code = 'VOYAGE_FARE' AND currency = 'GBP' AND prc.guestseq = 3 THEN prc.amount ELSE 0 END AS voyage_fare_guest3_gbp ,CASE WHEN prc.price_code = 'VOYAGE_FARE' AND currency = 'GBP' AND prc.guestseq = 4 THEN prc.amount ELSE 0 END AS voyage_fare_guest4_gbp ,CASE WHEN prc.price_code = 'DISCOUNT' AND currency = 'GBP' AND prc.guestseq = 1 THEN prc.amount ELSE 0 END AS DISCOUNT_GUEST1_gbp ,CASE WHEN prc.price_code = 'DISCOUNT' AND currency = 'GBP' AND prc.guestseq = 2 THEN prc.amount ELSE 0 END AS DISCOUNT_GUEST2_gbp ,CASE WHEN prc.price_code = 'DISCOUNT' AND currency = 'GBP' AND prc.guestseq = 3 THEN prc.amount ELSE 0 END AS DISCOUNT_GUEST3_gbp ,CASE WHEN prc.price_code = 'DISCOUNT' AND currency = 'GBP' AND prc.guestseq = 4 THEN prc.amount ELSE 0 END AS DISCOUNT_GUEST4_gbp ,CASE WHEN prc.price_code = 'TAXES_FEES' AND currency = 'AUD' THEN prc.amount ELSE 0 END AS taxes_and_fees_AUD ,CASE WHEN prc.price_code = 'VOYAGE_FARE' AND currency = 'AUD' AND prc.guestseq = 1 THEN prc.amount ELSE 0 END AS voyage_fare_guest1_AUD ,CASE WHEN prc.price_code = 'VOYAGE_FARE' AND currency = 'AUD' AND prc.guestseq = 2 THEN prc.amount ELSE 0 END AS voyage_fare_guest2_AUD ,CASE WHEN prc.price_code = 'VOYAGE_FARE' AND currency = 'AUD' AND prc.guestseq = 3 THEN prc.amount ELSE 0 END AS voyage_fare_guest3_AUD ,CASE WHEN prc.price_code = 'VOYAGE_FARE' AND currency = 'AUD' AND prc.guestseq = 4 THEN prc.amount ELSE 0 END AS voyage_fare_guest4_AUD ,CASE WHEN prc.price_code = 'DISCOUNT' AND currency = 'AUD' AND prc.guestseq = 1 THEN prc.amount ELSE 0 END AS DISCOUNT_GUEST1_AUD ,CASE WHEN prc.price_code = 'DISCOUNT' AND currency = 'AUD' AND prc.guestseq = 2 THEN prc.amount ELSE 0 END AS DISCOUNT_GUEST2_AUD ,CASE WHEN prc.price_code = 'DISCOUNT' AND currency = 'AUD' AND prc.guestseq = 3 THEN prc.amount ELSE 0 END AS DISCOUNT_GUEST3_AUD ,CASE WHEN prc.price_code = 'DISCOUNT' AND currency = 'AUD' AND prc.guestseq = 4 THEN prc.amount ELSE 0 END AS DISCOUNT_GUEST4_AUD ,CASE WHEN prc.price_code = 'TAXES_FEES' AND currency = 'CAD' THEN prc.amount ELSE 0 END AS taxes_and_fees_CAD ,CASE WHEN prc.price_code = 'VOYAGE_FARE' AND currency = 'CAD' AND prc.guestseq = 1 THEN prc.amount ELSE 0 END AS voyage_fare_guest1_CAD ,CASE WHEN prc.price_code = 'VOYAGE_FARE' AND currency = 'CAD' AND prc.guestseq = 2 THEN prc.amount ELSE 0 END AS voyage_fare_guest2_CAD ,CASE WHEN prc.price_code = 'VOYAGE_FARE' AND currency = 'CAD' AND prc.guestseq = 3 THEN prc.amount ELSE 0 END AS voyage_fare_guest3_CAD ,CASE WHEN prc.price_code = 'VOYAGE_FARE' AND currency = 'CAD' AND prc.guestseq = 4 THEN prc.amount ELSE 0 END AS voyage_fare_guest4_CAD ,CASE WHEN prc.price_code = 'DISCOUNT' AND currency = 'CAD' AND prc.guestseq = 1 THEN prc.amount ELSE 0 END AS DISCOUNT_GUEST1_CAD ,CASE WHEN prc.price_code = 'DISCOUNT' AND currency = 'CAD' AND prc.guestseq = 2 THEN prc.amount ELSE 0 END AS DISCOUNT_GUEST2_CAD ,CASE WHEN prc.price_code = 'DISCOUNT' AND currency = 'CAD' AND prc.guestseq = 3 THEN prc.amount ELSE 0 END AS DISCOUNT_GUEST3_CAD ,CASE WHEN prc.price_code = 'DISCOUNT' AND currency = 'CAD' AND prc.guestseq = 4 THEN prc.amount ELSE 0 END AS DISCOUNT_GUEST4_CAD FROM vv_db.tmp_pricing_detail prc ) sailapi GROUP BY sailapi.prc_sail_id ,sailapi.prc_category ) sailapi1 ON sailapi1.prc_sail_id = sd.sail_id AND c.cabin_category = sailapi1.prc_category "
