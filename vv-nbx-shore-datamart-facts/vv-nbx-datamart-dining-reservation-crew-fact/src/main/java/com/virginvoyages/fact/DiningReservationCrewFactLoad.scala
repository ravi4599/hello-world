...
object DiningReservationCrewFactLoad {
...
try{
val whereClause = s""" where mxp_res.batchtime>= '$batch_start_tme' and mxp_res.batchtime<='$batch_end_tme' and mxp_res.part_date >='$part_read_start' and mxp_res.part_date <='$part_read_end'"""
...
log.info("Loading Dining Reservation Crew fact table")
...
log.info("******************in the catch of Dining Reservation Crew Fact Load ******************");
e.printStackTrace();
