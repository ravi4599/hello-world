...
object DiningTableStatusFactLoad {
    // Creating logger
  ...
  def main(args: Array[String]): Unit = {
    ...
    try {
      ...
      val whereClause = s""" re.BatchTime>= '$batchStartTme' and re.BatchTime<='$batchEndTme' and re.Part_Date>='$partReadStart' and re.Part_Date<='$partReadEnd'"""
