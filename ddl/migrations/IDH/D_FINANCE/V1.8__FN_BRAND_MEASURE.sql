...
INNER JOIN IDS_DEV.TXN_BV.FN_SYSTEM_BV s
 ...
 on 1 = 1
INNER JOIN (select FN_MEASURE_ID, BRAND_ID from IDS_DEV.TXN.FN_BRAND_MEASURE where SALES_RECON_REPORT_DISPLAY_IND='TRUE') FBM on m.fn_measure_id = FBM.FN_MEASURE_ID and r.brand_id = FBM.BRAND_ID
