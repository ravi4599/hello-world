...
af_params = Variable.get('E2E_SALES_RECON_ALTAMETRICS_IDS_TO_IDS_WEEKLY', default_load_variable, deserialize_json=True)
...
from_date = af_params['ld_start_dt'] if af_params['ld_start_dt'] != '' \
                                     ...
                                     else pendulum.now('US/Eastern').add(days=-7).format('YYYYMMDD')
...
with DAG(
    ...
    E2E_SALES_RECON_ALTAMETRICS_IDS_TO_IDS_WEEKLY = SnowflakeOperator(
       task_id='E2E_SALES_RECON_ALTAMETRICS_IDS_TO_IDS_WEEKLY',
       snowflake_conn_id=snowflake_conn_id,
       sql='ids/arbys/transform-altametrics-weekly-ids-to-ids.sql',
       params={
                "warehouse": warehouse,
...
# Task Run Flow
Start >> E2E_SALES_RECON_ALTAMETRICS_IDS_TO_IDS_WEEKLY >> End
# Task Run Flow End
