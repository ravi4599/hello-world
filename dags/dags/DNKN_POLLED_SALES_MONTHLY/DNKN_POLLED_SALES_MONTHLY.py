...
af_params = Variable.get('DNKN_POLLED_SALES_MONTHLY' ,default_load_variable, deserialize_json=True)
...
file_name = 'DKN_UDP_Finance_PolledSales_' + loaddt + '_Monthly.dat'
...
with DAG(
 ...
 COPY_TO_ADLS = SnowflakeOperator(
    ...
    sql = 'polled_sales/dunkin/unload-dunkin-pos-rds-to-adls-monthly.sql',
    params={
             "warehouse": warehouse
            , "schema": schema
            , "env": env
