...
with DAG(**dag_config) as dag:
    ...
    E2E_SALES_RECON_SDI_ORACLEGL_FTP_TO_ADLS = TriggerDagRunOperator(
        task_id='E2E_SALES_RECON_SDI_ORACLEGL_FTP_TO_ADLS',
        trigger_dag_id=confs['child_dags']['E2E_SALES_RECON_SDI_ORACLEGL_FTP_TO_ADLS'],
        wait_for_completion=True,
        poke_interval=60
    )

    E2E_SALES_RECON_SDI_ORACLEGL_ADLS_TO_RDS = TriggerDagRunOperator(
        task_id='E2E_SALES_RECON_SDI_ORACLEGL_ADLS_TO_RDS',
        trigger_dag_id=confs['child_dags']['E2E_SALES_RECON_SDI_ORACLEGL_ADLS_TO_RDS'],
        wait_for_completion=True,
        poke_interval=60
    )

    E2E_SALES_RECON_SDI_ORACLEGL_RDS_TO_IDS = TriggerDagRunOperator(
        task_id='E2E_SALES_RECON_SDI_ORACLEGL_RDS_TO_IDS',
        trigger_dag_id=confs['child_dags']['E2E_SALES_RECON_SDI_ORACLEGL_RDS_TO_IDS'],
        wait_for_completion=True,
        poke_interval=60
    )
...
chain(Start, [E2E_SALES_RECON_SDI_ORACLEGL_FTP_TO_ADLS])
cross_downstream([E2E_SALES_RECON_SDI_ORACLEGL_FTP_TO_ADLS],[E2E_SALES_RECON_SDI_ORACLEGL_ADLS_TO_RDS])
cross_downstream([E2E_SALES_RECON_SDI_ORACLEGL_ADLS_TO_RDS],[E2E_SALES_RECON_SDI_ORACLEGL_RDS_TO_IDS])
cross_downstream([E2E_SALES_RECON_SDI_ORACLEGL_RDS_TO_IDS],[End])
