...
af_params = Variable.get('E2E_SALES_RECON_BWW_NBO_RDS_TO_IDS_DAILY', default_load_variable, deserialize_json=True)
...
from_date = af_params['ld_start_dt'] if af_params['ld_start_dt'] != '' \
                                     ...
                                     else pendulum.now('America/New_York').add(days=-8).format('YYYYMMDD')
...
with DAG(
 ...
 E2E_SALES_RECON_BWW_NBO_RDS_TO_IDS_DAILY = SnowflakeOperator(
    task_id='E2E_SALES_RECON_BWW_NBO_RDS_TO_IDS_DAILY',
    snowflake_conn_id=snowflake_conn_id,
    sql = 'ids/bww/transform-bww-nbo-daily-rds-to-ids.sql',
    params={
             "warehouse": warehouse
...
#Task Run Flow
Start>>E2E_SALES_RECON_BWW_NBO_RDS_TO_IDS_DAILY  
E2E_SALES_RECON_BWW_NBO_RDS_TO_IDS_DAILY>>End
#Task Run Flow End
