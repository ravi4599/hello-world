...
af_params = Variable.get('ARBYS_POS_REVENUE_CENTER_RDS_TO_IDS_DAILY', default_load_variable, deserialize_json=True)
...
with DAG(
    ...
    ARBYS_POS_REVENUE_CENTER_RDS_TO_IDS_DAILY_ALL_HI_PL = SnowflakeOperator(
       task_id='ARBYS_POS_REVENUE_CENTER_RDS_TO_IDS_DAILY_ALL_HI_PL',
       snowflake_conn_id=snowflake_conn_id,
       sql='ids/arbys/transform-parbrinks-revenue-center-rds-to-ids.sql',
       params={
                "warehouse": warehouse,
...
# Task Run Flow
Start >> ARBYS_POS_REVENUE_CENTER_RDS_TO_IDS_DAILY_ALL_HI_PL >> End
# Task Run Flow End
