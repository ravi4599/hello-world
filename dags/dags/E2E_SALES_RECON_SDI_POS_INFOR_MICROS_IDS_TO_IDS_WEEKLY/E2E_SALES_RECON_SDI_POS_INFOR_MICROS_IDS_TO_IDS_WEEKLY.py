...
af_params = Variable.get('E2E_SALES_RECON_SDI_POS_INFOR_MICROS_IDS_TO_IDS_WEEKLY', default_load_variable, deserialize_json=True)
...
with DAG(
    ...
    tags = ['SONIC', 'SALESRECON_SONIC', 'IDS_TO_IDS'],
 ...
 E2E_SALES_RECON_SDI_POS_INFOR_MICROS_IDS_TO_IDS_WEEKLY = SnowflakeOperator(
    task_id='E2E_SALES_RECON_SDI_POS_INFOR_MICROS_IDS_TO_IDS_WEEKLY',
    snowflake_conn_id=snowflake_conn_id,
    sql = 'ids/sdi/transform-sdi-pos-infor-micros-weekly-ids-to-ids.sql',
    params={
             "warehouse": warehouse
...
#Task Run Flow
Start>>E2E_SALES_RECON_SDI_POS_INFOR_MICROS_IDS_TO_IDS_WEEKLY  
E2E_SALES_RECON_SDI_POS_INFOR_MICROS_IDS_TO_IDS_WEEKLY>>End
#Task Run Flow End
