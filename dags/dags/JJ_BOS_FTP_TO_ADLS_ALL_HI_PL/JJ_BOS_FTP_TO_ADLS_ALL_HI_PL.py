...
with DAG(
    ...
    tags = ['BOS', 'SALESRECON_JJ', 'FTP_TO_ADLS'],
 ...
 JJ_BOS_FTP_TO_ADLS_ALL_HI_PL = RunADFPipelineoperator(
...
#Task Run Flow
Start>>JJ_BOS_FTP_TO_ADLS_ALL_HI_PL  
JJ_BOS_FTP_TO_ADLS_ALL_HI_PL>>End
#Task Run Flow End
