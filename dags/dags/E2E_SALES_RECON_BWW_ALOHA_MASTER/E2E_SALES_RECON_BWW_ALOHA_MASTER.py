...
with DAG(**dag_config) as dag:
    ...
    E2E_SALES_RECON_BWW_ALOHA_IDS_TO_IDS_DAILY = TriggerDagRunOperator(
        task_id='E2E_SALES_RECON_BWW_ALOHA_IDS_TO_IDS_DAILY',
        trigger_dag_id=confs['child_dags']['E2E_SALES_RECON_BWW_ALOHA_IDS_TO_IDS_DAILY'],
        wait_for_completion=True,
        poke_interval=60
    )

    E2E_SALES_RECON_BWW_ALOHA_IDS_TO_IDS_WEEKLY = TriggerDagRunOperator(
        task_id='E2E_SALES_RECON_BWW_ALOHA_IDS_TO_IDS_WEEKLY',
        trigger_dag_id=confs['child_dags']['E2E_SALES_RECON_BWW_ALOHA_IDS_TO_IDS_WEEKLY'],
        wait_for_completion=True,
        poke_interval=60
    )
    
    E2E_SALES_RECON_BWW_ALOHA_DQ = TriggerDagRunOperator(
        task_id='E2E_SALES_RECON_BWW_ALOHA_DQ',
        trigger_dag_id=confs['child_dags']['E2E_SALES_RECON_BWW_ALOHA_DQ'],
        wait_for_completion=True,
        poke_interval=60
    )
...
Start >> E2E_SALES_RECON_BWW_ALOHA_IDS_TO_IDS_DAILY >> E2E_SALES_RECON_BWW_ALOHA_IDS_TO_IDS_WEEKLY >> E2E_SALES_RECON_BWW_ALOHA_DQ >> End
