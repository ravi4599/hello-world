...
af_params = Variable.get('E2E_SALES_RECON_BWW_NBO_SQL_TO_RDS', default_load_variable, deserialize_json=True)
ld_file_date = pendulum.now('America/New_York').add(days=0).format('YYYYMMDD')
...
params_nbo_st_register_audit = {
    ...
    'RDS_TABLE' : 'NBO_ST_REGISTER',
    'SOURCE_SYSTEM_NAME' : 'NBO_Sales',
    'LOADID_C' : 'loadid',
...
with DAG(
    ...
    E2E_SALES_RECON_BWW_NBO_SQL_TO_ADLS = RunADFPipelineoperator(
       task_id='E2E_SALES_RECON_BWW_NBO_SQL_TO_ADLS',
    ...
    E2E_SR_NBO_CHECKFILE_SIZE = RunADFPipelineoperator(
       task_id='E2E_SR_NBO_CHECKFILE_SIZE',
    ...
    E2E_SALES_RECON_BWW_NBO_ADLS_TO_RDS = SnowflakeOperator(
       ...
       params={
                ...
                "pattern": pattern,
                "load_start_dt": ld_start_date,
                "load_end_dt": ld_end_date,
                "run_date": ld_file_date
       },
       dag=dag
     )
     
trigger_audit_nbo_st_register = TriggerDagRunOperator(
           task_id='trigger_audit_nbo_st_register',
           trigger_dag_id='UDP_Audit_Validation',
           conf=params_nbo_st_register_audit,
           dag=dag
            )

# Task Run Flow
Start >> E2E_SALES_RECON_BWW_NBO_SQL_TO_ADLS
E2E_SALES_RECON_BWW_NBO_SQL_TO_ADLS >> E2E_SR_NBO_CHECKFILE_SIZE
E2E_SR_NBO_CHECKFILE_SIZE >> E2E_SALES_RECON_BWW_NBO_ADLS_TO_RDS
E2E_SALES_RECON_BWW_NBO_ADLS_TO_RDS >> trigger_audit_nbo_st_register
trigger_audit_nbo_st_register >> End
# Task Run Flow End
