...
af_params = Variable.get('ARBYS_POLLED_SALES_MONTHLY', default_load_variable, deserialize_json=True)
...
file_name = 'ARBYS_UDP_Finance_PolledSales_' + loaddt + '_Monthly.dat'
#file_name = 'ARBYS_UDP_Finance_PolledSales_20240215_Monthly.dat'
...
default_args = {
    ...
    'start_date': pendulum.datetime(2024,2,5).in_tz('America/New_York'),
    'retries': 0
}
...
with DAG(
    ...
    tags = ['ARBYS', 'SALESRECON_ARBYS', 'IDH_TO_ADLS'],
 ...
 ARBYS_POLLED_SALES_MONTHLY = SnowflakeOperator(
    task_id='ARBYS_POLLED_SALES_MONTHLY',
    snowflake_conn_id=snowflake_conn_id,
    sql = 'polled_sales/arbys/unload-arbys-rds-to-adls-monthly.sql',
    params={
             "warehouse": warehouse
            , "schema": schema
            , "env": env
...
###Task Run Flow
Start >> ARBYS_POLLED_SALES_MONTHLY >> COPY_TO_ORACLE_PIPELINE >> End
#Task Run Flow End-------------
