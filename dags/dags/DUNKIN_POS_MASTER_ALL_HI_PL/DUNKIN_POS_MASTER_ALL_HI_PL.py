...
with DAG(**dag_config) as dag:
    ...
    DUNKIN_POS_IDS_TO_IDS_DAILY = TriggerDagRunOperator(
        task_id='DUNKIN_POS_IDS_TO_IDS_DAILY_ALL_HI_PL',
        trigger_dag_id=confs['child_dags']['E2E_SALES_RECON_DNKN_IDS_TO_IDS_DAILY'],
        wait_for_completion=True,
        poke_interval=60
    )
    
    DUNKIN_POS_DQ = TriggerDagRunOperator(
        task_id='DUNKIN_POS_DQ',
        trigger_dag_id=confs['child_dags']['DUNKIN_POS_DQ'],
        wait_for_completion=True,
        poke_interval=60
    )
...
chain(Start, [DUNKIN_POS_IDS_TO_IDS_DAILY])
cross_downstream([DUNKIN_POS_IDS_TO_IDS_DAILY],[DUNKIN_POS_DQ])
cross_downstream([DUNKIN_POS_DQ],[End])