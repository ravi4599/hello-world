...
af_params = Variable.get('E2E_SALES_RECON_BWW_GND_ITEM_ADLS_GEN2_TO_RDS', default_load_variable, deserialize_json=True)
...
with DAG( dag_id = confs.get('dag_id'),
    ...
    prev_task = Start
    with TaskGroup(group_id="BWW_GEN2_ADLS_RDS") as BWW_GEN2_ADLS_RDS:
...
Start >> [BWW_GEN2_ADLS_RDS]
[BWW_GEN2_ADLS_RDS] >> End
