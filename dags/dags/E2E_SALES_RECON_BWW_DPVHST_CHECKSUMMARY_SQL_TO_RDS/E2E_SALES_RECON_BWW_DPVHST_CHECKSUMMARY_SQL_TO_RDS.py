...
af_params = Variable.get('E2E_SALES_RECON_BWW_DPVHST_CHECKSUMMARY_SQL_TO_RDS', default_load_variable, deserialize_json=True)
...
with DAG(
    ...
    E2E_SALES_RECON_BWW_DPVHST_CHECKSUMMARY_SQL_TO_ADLS = RunADFPipelineoperator(
       task_id='E2E_SALES_RECON_BWW_DPVHST_CHECKSUMMARY_SQL_TO_ADLS',
    ...
    E2E_SR_CHECKSUMMARY_CHECKFILE_SIZE = RunADFPipelineoperator(
       task_id='E2E_SR_CHECKSUMMARY_CHECKFILE_SIZE',
    ...
    E2E_SALES_RECON_BWW_DPVHST_CHECKSUMMARY_ADLS_TO_RDS = SnowflakeOperator(
       task_id='E2E_SALES_RECON_BWW_DPVHST_CHECKSUMMARY_ADLS_TO_RDS',
       snowflake_conn_id=snowflake_conn_id,
       sql='rds/bww/ingest-bww-checksummary-adls-to-rds.sql',
       params={
                "warehouse": warehouse,
                "schema": schema,
                "env": env,
...
# Task Run Flow
Start >> E2E_SALES_RECON_BWW_DPVHST_CHECKSUMMARY_SQL_TO_ADLS
E2E_SALES_RECON_BWW_DPVHST_CHECKSUMMARY_SQL_TO_ADLS >> E2E_SR_CHECKSUMMARY_CHECKFILE_SIZE
E2E_SR_CHECKSUMMARY_CHECKFILE_SIZE >> E2E_SALES_RECON_BWW_DPVHST_CHECKSUMMARY_ADLS_TO_RDS
E2E_SALES_RECON_BWW_DPVHST_CHECKSUMMARY_ADLS_TO_RDS >> End
# Task Run Flow End
