...
af_params = Variable.get('E2E_SALES_RECON_SDI_BOS_INFOR_MICROS_RDS_TO_IDS_DAILY', default_load_variable, deserialize_json=True)
...
with DAG(
    ...
    tags = ['SDI', 'SALESRECON_SONIC', 'RDS_TO_IDS'],
 ...
 E2E_SALES_RECON_SDI_BOS_INFOR_RDS_TO_IDS_DAILY = SnowflakeOperator(
    task_id='E2E_SALES_RECON_SDI_BOS_INFOR_RDS_TO_IDS_DAILY',
    snowflake_conn_id=snowflake_conn_id,
    sql = 'ids/sdi/transform-sdi-bos-infor-daily-rds-to-ids.sql',
    params={
             "warehouse": warehouse
 ...
 E2E_SALES_RECON_SDI_BOS_MICROS_RDS_TO_IDS_DAILY = SnowflakeOperator(
    task_id='E2E_SALES_RECON_SDI_BOS_MICROS_RDS_TO_IDS_DAILY',
    snowflake_conn_id=snowflake_conn_id,
    sql = 'ids/sdi/transform-sdi-bos-micros-daily-rds-to-ids.sql',
    params={
             "warehouse": warehouse
            , "source_env": source_env
            , "target_env": target_env
...
#Task Run Flow
Start>>E2E_SALES_RECON_SDI_BOS_INFOR_RDS_TO_IDS_DAILY  
E2E_SALES_RECON_SDI_BOS_INFOR_RDS_TO_IDS_DAILY>>E2E_SALES_RECON_SDI_BOS_MICROS_RDS_TO_IDS_DAILY
E2E_SALES_RECON_SDI_BOS_MICROS_RDS_TO_IDS_DAILY>>End
#Task Run Flow End
