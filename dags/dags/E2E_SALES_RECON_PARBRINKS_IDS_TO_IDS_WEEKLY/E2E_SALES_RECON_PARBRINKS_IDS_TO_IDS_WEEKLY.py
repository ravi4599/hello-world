...
af_params = Variable.get('E2E_SALES_RECON_PARBRINKS_IDS_TO_IDS_WEEKLY', default_load_variable, deserialize_json=True)
...
with DAG(
    ...
    E2E_SALES_RECON_PARBRINKS_IDS_TO_IDS_WEEKLY = SnowflakeOperator(
       task_id='E2E_SALES_RECON_PARBRINKS_IDS_TO_IDS_WEEKLY',
       snowflake_conn_id=snowflake_conn_id,
       sql='ids/arbys/transform-parbrinks-weekly-ids-to-ids.sql',
       params={
                "warehouse": warehouse,
...
# Task Run Flow
Start >> E2E_SALES_RECON_PARBRINKS_IDS_TO_IDS_WEEKLY >> End
# Task Run Flow End
