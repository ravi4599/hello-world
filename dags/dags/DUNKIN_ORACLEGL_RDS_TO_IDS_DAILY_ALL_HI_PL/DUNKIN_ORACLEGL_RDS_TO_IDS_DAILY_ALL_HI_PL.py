"""
This DAG loads DUNKIN's ORACLEGL data from RDS to IDS Daily table in snowflake.
"""
...
af_params = Variable.get('DUNKIN_ORACLEGL_RDS_TO_IDS_DAILY_ALL_HI_PL', default_load_variable, deserialize_json=True)
...
with DAG(
    ...
    tags=['GL', 'SALESRECON_DUNKIN', 'RDS_TO_IDS'],
    ...
    DUNKIN_ORACLEGL_RDS_TO_IDS_DAILY = SnowflakeOperator(
       task_id='DUNKIN_ORACLEGL_RDS_TO_IDS_DAILY_ALL_HI_PL',
       snowflake_conn_id=snowflake_conn_id,
       sql='ids/dunkin/transform-dunkin-oraclegl-daily-rds-to-ids.sql',
       params={
                "warehouse": warehouse,
...
# Task Run Flow
Start >> DUNKIN_ORACLEGL_RDS_TO_IDS_DAILY >> End
# Task Run Flow End
