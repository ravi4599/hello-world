...
af_params = Variable.get('E2E_SALES_RECON_ALTAMETRICS_RDS_TO_IDS_DAILY', default_load_variable, deserialize_json=True)
...
from_date = af_params['ld_start_dt'] if af_params['ld_start_dt'] != '' \
                                     ...
                                     else pendulum.now('US/Eastern').add(days=-8).format('YYYYMMDD')
...
with DAG(
    ...
    tags=['ARBYS', 'SALESRECON_ARBYS', 'RDS_TO_IDS'],
    ...
    E2E_SALES_RECON_ALTAMETRICS_RDS_TO_IDS_DAILY = SnowflakeOperator(
       task_id='E2E_SALES_RECON_ALTAMETRICS_RDS_TO_IDS_DAILY',
       snowflake_conn_id=snowflake_conn_id,
       sql='ids/arbys/transform-altametrics-daily-rds-to-ids.sql',
       params={
                "warehouse": warehouse,
...
# Task Run Flow
Start >> E2E_SALES_RECON_ALTAMETRICS_RDS_TO_IDS_DAILY >> End
