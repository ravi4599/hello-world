...
af_params = Variable.get('BSKN_POLLED_SALES_MONTHLY', default_load_variable, deserialize_json=True)
...
file_name = 'BRI_UDP_Finance_PolledSales_' + loaddt + '_Monthly.dat'
...
with DAG(
 ...
 BSKN_POLLED_SALES_MONTHLY = SnowflakeOperator(
    task_id='BSKN_POLLED_SALES_MONTHLY',
    snowflake_conn_id=snowflake_conn_id,
    sql = 'polled_sales/baskin/unload-baskin-bos-rds-to-adls-monthly.sql',
    params={
            "warehouse": warehouse
            , "schema": schema
            , "env": env
...
#Task Run Flow
 Start >> BSKN_POLLED_SALES_MONTHLY >> COPY_TO_ORACLE_PIPELINE >> End
#Task Run Flow End
