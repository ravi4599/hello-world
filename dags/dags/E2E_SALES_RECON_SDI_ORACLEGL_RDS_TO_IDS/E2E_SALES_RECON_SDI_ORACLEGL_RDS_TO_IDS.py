...
af_params = Variable.get('E2E_SALES_RECON_SDI_ORACLEGL_RDS_TO_IDS', default_load_variable, deserialize_json=True)
...
with DAG(
 ...
 E2E_SALES_RECON_SDI_ORACLEGL_RDS_TO_IDS = SnowflakeOperator(
    task_id='E2E_SALES_RECON_SDI_ORACLEGL_RDS_TO_IDS',
    snowflake_conn_id=snowflake_conn_id,
    sql = 'ids/sdi/transform-sdi-oraclegl-rds-to-ids.sql',
    params={
             "warehouse": warehouse
...
#Task Run Flow
Start>>E2E_SALES_RECON_SDI_ORACLEGL_RDS_TO_IDS  
E2E_SALES_RECON_SDI_ORACLEGL_RDS_TO_IDS>>End
#Task Run Flow End
