"""
This DAG loads BWW's ORACLEGL data from FTP to Azure Data Lake Storage Gen2.
"""
...
with DAG(
    ...
    tags = ['BWW', 'SALESRECON_BWW', 'FTP_TO_ADLS'],
 ...
 E2E_SALES_RECON_BWW_ORACLEGL_FTP_TO_ADLS = RunADFPipelineoperator(
...
#Task Run Flow
Start>>E2E_SALES_RECON_BWW_ORACLEGL_FTP_TO_ADLS>>End  
