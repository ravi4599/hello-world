"""
This DAG loads DNKN's ORACLEGL data from FTP to Azure Data Lake Storage Gen2.
"""
...
with DAG(
    ...
    tags=['GL', 'SALESRECON_DUNKIN', 'FTP_TO_ADLS'],
    ...
    DUNKIN_ORACLEGL_FTP_TO_ADLS = RunADFPipelineoperator(
       task_id='DUNKIN_ORACLEGL_SFTP_TO_ADLS_ALL_HI_PL',
...
# Task Run Flow
Start >> DUNKIN_ORACLEGL_FTP_TO_ADLS >> End
# Task Run Flow End
