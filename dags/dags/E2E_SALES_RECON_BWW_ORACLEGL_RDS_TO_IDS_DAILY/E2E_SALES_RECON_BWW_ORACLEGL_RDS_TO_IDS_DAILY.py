"""
This DAG loads BWW's ORACLEGL data from RDS to IDS Daily table in snowflake.
"""
...
af_params = Variable.get('E2E_SALES_RECON_BWW_ORACLEGL_RDS_TO_IDS_DAILY', default_load_variable, deserialize_json=True)
...
with DAG(
 ...
 E2E_SALES_RECON_BWW_ORACLEGL_RDS_TO_IDS_DAILY = SnowflakeOperator(
    task_id='E2E_SALES_RECON_BWW_ORACLEGL_RDS_TO_IDS_DAILY',
    snowflake_conn_id=snowflake_conn_id,
    sql = 'ids/bww/transform-bww-oraclegl-daily-rds-to-ids.sql',
    params={
             "warehouse": warehouse
...
#Task Run Flow
Start>>E2E_SALES_RECON_BWW_ORACLEGL_RDS_TO_IDS_DAILY  
E2E_SALES_RECON_BWW_ORACLEGL_RDS_TO_IDS_DAILY>>End
#Task Run Flow End
