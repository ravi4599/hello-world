"""
This DAG loads BWW's ORACLEGL data from Azure Data Lake Storage Gen2 to RDS in snowflake.
"""
...
af_params = Variable.get('E2E_SALES_RECON_BWW_ORACLEGL_ADLS_TO_RDS', default_load_variable, deserialize_json=True)
...
params_oracle_gl_sales_raw_table_audit = {
...
with DAG(
 ...
 trigger_audit_Oracle_GL = TriggerDagRunOperator(
        ...
        conf=params_oracle_gl_sales_raw_table_audit 
    )

 E2E_SALES_RECON_BWW_ORACLEGL_ADLS_TO_RDS = SnowflakeOperator(
    task_id='E2E_SALES_RECON_BWW_ORACLEGL_ADLS_TO_RDS',
    snowflake_conn_id=snowflake_conn_id,
    sql = 'rds/bww/ingest-bww-oraclegl-adls-to-rds.sql',
    params={
             "warehouse": warehouse
            , "schema": schema
            , "env": env
...
#Task Run Flow
Start >> E2E_SALES_RECON_BWW_ORACLEGL_ADLS_TO_RDS >> trigger_audit_Oracle_GL >> End
#Task Run Flow End
