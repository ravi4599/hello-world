...
af_params = Variable.get('BSKN_POLLED_SALES_WEEKLY' ,default_load_variable, deserialize_json=True)
...
file_name = 'BRI_UDP_Finance_PolledSales_' + loaddt + '_Weekly.dat'
...
with DAG(
    ...
    tags = ['BSKN', 'SALESRECON_BASKIN', 'IDH_TO_ADLS'],
 ...
 BSKN_POLLED_SALES_WEEKLY = SnowflakeOperator(
    task_id='BSKN_POLLED_SALES_WEEKLY',
    snowflake_conn_id=snowflake_conn_id,
    sql = 'polled_sales/baskin/unload-baskin-pos-rds-to-adls-weekly.sql',
    params={
             "warehouse": warehouse
            , "schema": schema
            , "env": env
...
#Task Run Flow
Start>>BSKN_POLLED_SALES_WEEKLY>>COPY_TO_ORACLE_PIPELINE>>End
#Task Run Flow End-----------
