...
af_params = Variable.get('E2E_SALES_RECON_SDI_POS_INFOR_MICROS_IDS_TO_IDS_DAILY', default_load_variable, deserialize_json=True)
...
with DAG(
 ...
 E2E_SALES_RECON_SDI_POS_INFOR_MICROS_IDS_TO_IDS_DAILY = SnowflakeOperator(
    task_id='E2E_SALES_RECON_SDI_POS_INFOR_MICROS_IDS_TO_IDS_DAILY',
    snowflake_conn_id=snowflake_conn_id,
    sql = 'ids/sdi/transform-sdi-pos-infor-micros-daily-ids-to-ids.sql',
    params={
             "warehouse": warehouse
...
#Task Run Flow
Start>>E2E_SALES_RECON_SDI_POS_INFOR_MICROS_IDS_TO_IDS_DAILY  
E2E_SALES_RECON_SDI_POS_INFOR_MICROS_IDS_TO_IDS_DAILY>>End
#Task Run Flow End
