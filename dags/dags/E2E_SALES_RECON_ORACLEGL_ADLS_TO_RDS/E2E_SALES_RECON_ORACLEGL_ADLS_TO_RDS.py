...
af_params = Variable.get('E2E_SALES_RECON_ORACLEGL_ADLS_TO_RDS', default_load_variable, deserialize_json=True)
...
SALES_RECON_ORACLEGL_ADLS_TO_RDS = SnowflakeOperator(
       task_id='SALES_RECON_ORACLEGL_ADLS_TO_RDS',
       snowflake_conn_id=snowflake_conn_id,
       sql='rds/arbys/ingest-arb-oraclegl-adls-to-rds.sql',
       params={
                "warehouse": warehouse,
                "schema": schema,
                "env": env,
...
# Task Run Flow
Start >> SALES_RECON_ORACLEGL_ADLS_TO_RDS >> trigger_audit_Oracle_GL >> End
