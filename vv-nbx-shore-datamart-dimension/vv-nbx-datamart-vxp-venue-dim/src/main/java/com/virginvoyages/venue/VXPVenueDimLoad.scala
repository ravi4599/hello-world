package com.virginvoyages.venue
...
/*************************************calling metadata framework*********************************************/
    ...
    try {
      ...
      val whereClause = s""" where venues.batchtime>= '$batch_start_tme' and venues.batchtime<='$batch_end_tme' and venues.part_date>='$part_read_start' and venues.part_date<='$part_read_end'"""
