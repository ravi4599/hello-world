...
val interDF=stageSailDimDF.select($"HOTEL_ID",$"REC_START_DTTM",$"REC_END_DTTM",$"HOTEL_CODE",$"HOTEL_NAME",$"HOTEL_TYPE",$"IS_ACTIVE",$"HOTEL_RATING",$"ADDRESS_TYPE",$"ADDRESS_LINE1",$"ADDRESS_LINE2",$"ADDRESS_LINE3",$"ADDRESS_LINE4",$"ADDRESS_CITY",$"ZIP",$"COUNTRY_CODE")
