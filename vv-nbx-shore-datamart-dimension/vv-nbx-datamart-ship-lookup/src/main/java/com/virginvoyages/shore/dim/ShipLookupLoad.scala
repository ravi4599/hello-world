  ...
  def main(args: Array[String]): Unit = {
	...
	/*************************************calling metadata framework*********************************************/
	   ...
	   try {
		 ...
		 var ShipLkp = spark.sql(spark.sparkContext.getConf.get("spark.source.sql").trim())
		 ...
		 val stage_final_df = missing_columns.foldLeft(ShipLkp)((df, c) =>
