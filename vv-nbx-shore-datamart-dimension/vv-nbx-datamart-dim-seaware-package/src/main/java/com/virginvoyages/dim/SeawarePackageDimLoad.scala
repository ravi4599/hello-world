...
/*************************************calling metadata framework*********************************************/
    ...
    try {
     ...
     /* val stageVoyageDF = spark.sql(spark.sparkContext.getConf.get("spark.source.sql"))*/
      ...
      //val interDF=stageSailDimDF.select($"src_package_id",$"package_class",$"product_type",$"package_type",$"package_code",$"package_name",$"src_sail_id",$"shorex_mode",$"vacation_date",$"shorex_timing",$"geog_area_code",$"season_code",$"is_active",$"shorex_total_spots",$"shorex_min_spots",greatest($"ts_ms_pd", $"ts_ms_pt",$"ts_ms_vafv", $"ts_ms_fv_min") as "src_date")
      
      val interDF=stageSailDimDF.select($"src_package_id",$"package_class",$"product_type",$"package_type",$"package_code",$"package_name",$"src_sail_id",$"shorex_mode",$"vacation_date",$"shorex_timing",$"geog_area_code",$"season_code",$"is_active",$"shorex_total_spots",$"shorex_min_spots",$"shorex_max_spots",greatest($"ts_ms_pd",$"ts_ms_pt",$"ts_ms_vafv",$"ts_ms_fv_min",$"ts_ms_fv_max") as "src_date")
      ...
      println("xxxxxxxxxxxxxxxxxxxxxxxxxxxxx-------------------------------Source-Stage Package------------------------------------xxxxxxxxxxxxxxxxxxxxxx")
