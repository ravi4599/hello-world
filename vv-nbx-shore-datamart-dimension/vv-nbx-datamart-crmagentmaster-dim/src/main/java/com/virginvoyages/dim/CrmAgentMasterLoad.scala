...
spark.sparkContext.getConf.get("spark.sql.crossJoin.enabled")
...
val interDF=stageSailDimDF.select($"Id",$"seaware_agent_id__c",$"name",$"lastname",$"firstname",$"mailingcity",$"mailingcountry",$"mailingpostalcode",$"mailingstate",$"mailingstreet",$"othercity",$"othercountry",$"otherphone",$"otherpostalcode",$"otherstate",$"otherstreet",$"seaware_agencyid__c",$"createddate",$"agent_status__c",$"agent_type_c",$"preferred_contact_phone_number__c",$"email",$"ownerid",$"role__c",$"fmdc_approver__c",$"seacity_access_key__c",$"taConnect_Agency_Type__c",$"taConnect_Are_you_a_Travel_Agent__c",$"taConnect_Are_You_Retired__c",$"taConnect_Bookings_via_Host_Agency__c",$"taConnect_Host_Agency__c",$"taConnect_Selling_Destination_1__c",$"taConnect_Selling_Destination_2__c",$"taConnect_Selling_Destination_3__c",$"taConnect_Travel_Type_1__c",$"taConnect_Travel_Type_2__c",$"taConnect_Travel_Type_3__c",$"taConnect_Travel_Type_4__c",$"taConnect_Years_of_Experience__c",$"LastModifiedDate" as "src_date" )
...
println("xxxxxxxxxxxxxxxxxxxxxxxxxxxxx-------------------------------Source-Stage Task------------------------------------xxxxxxxxxxxxxxxxxxxxxx")
...
case e: Exception =>
{ ManageMetadata.updateStatus(batch_instance_id1, batch_id1, "Failed", spark); log.info("******************in the catch of Package Dimension Load ******************"); e.printStackTrace(); throw new Exception("General Exception..please check the stacktrace", e); }
