...
/*************************************calling metadata framework*********************************************/
    ...
    try {
     ...
     val whereClause = s""" where spa_util.batchtime>= '$batch_start_tme' and spa_util.batchtime<='$batch_end_tme' and spa_util.part_date>='$part_read_start' and spa_util.part_date<='$part_read_end'"""
