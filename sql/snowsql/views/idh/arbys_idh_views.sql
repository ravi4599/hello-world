create or replace view IDH_{{params.env}}.D_FINANCE.BOS_DAILY_SALES_MEASURE(
	BUSINESS_DATE,
	BRAND_ID,
	REST_ID,
	MEASURE_NAME,
...
(
    SELECT 'arbys' brand_id, CURRENT_DATE - 180 ST_DATE, CURRENT_DATE END_DATE 
)
, CTE_REST as
(
...
create or replace view IDH_{{params.env}}.D_FINANCE.BOS_WEEKLY_SALES_MEASURE(
	FISC_WK_END_DATE,
	BRAND_ID,
	REST_ID,
	MEASURE_NAME,
...
create or replace view IDH_{{params.env}}.D_FINANCE.GL_WEEKLY_SALES_MEASURE(
	FISC_WK_END_DATE,
	BRAND_ID,
	REST_ID,
	MEASURE_NAME,
...
create or replace view IDH_{{params.env}}.D_FINANCE.POS_DAILY_SALES_MEASURE(
	BUSINESS_DATE,
	BRAND_ID,
	REST_ID,
	MEASURE_NAME,
...
create or replace view IDH_{{params.env}}.D_FINANCE.POS_WEEKLY_SALES_MEASURE(
	FISC_WK_END_DATE,
	BRAND_ID,
	REST_ID,
	MEASURE_NAME,
