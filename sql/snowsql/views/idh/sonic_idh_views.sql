-- SONIC BOS Daily view
create or replace view IDH_{{params.env}}.D_FINANCE.BOS_DAILY_SALES_MEASURE_SONIC(
	BUSINESS_DATE,
	BRAND_ID,
	REST_ID,
	MEASURE_NAME,
...
(
    SELECT 'sonic' brand_id, CURRENT_DATE - 120 ST_DATE, CURRENT_DATE END_DATE 
)
, CTE_REST as
(
...
--SONIC BOS Weekly view	
create or replace view IDH_{{params.env}}.D_FINANCE.BOS_WEEKLY_SALES_MEASURE_SONIC(
	FISC_WK_END_DATE,
	BRAND_ID,
	REST_ID,
	MEASURE_NAME,
...
--SONIC GL Weekly view
create or replace view IDH_{{params.env}}.D_FINANCE.GL_WEEKLY_SALES_MEASURE_SONIC(
	FISC_WK_END_DATE,
	BRAND_ID,
	REST_ID,
	MEASURE_NAME,
...
--SONIC POS Daily view	
create or replace view IDH_{{params.env}}.D_FINANCE.POS_DAILY_SALES_MEASURE_SONIC(
	BUSINESS_DATE,
	BRAND_ID,
	REST_ID,
	MEASURE_NAME,
...
--SONIC POS Weekly view
create or replace view IDH_{{params.env}}.D_FINANCE.POS_WEEKLY_SALES_MEASURE_SONIC(
	FISC_WK_END_DATE,
	BRAND_ID,
	REST_ID,
	MEASURE_NAME,
