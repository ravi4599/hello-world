create or replace view IDH_{{params.env}}.D_FINANCE.BOS_DAILY_SALES_MEASURE_JJ(
	BUSINESS_DATE,
	BRAND_ID,
	REST_ID,
	MEASURE_NAME,
...
(
    SELECT 'jj' brand_id, CURRENT_DATE - 120 ST_DATE, CURRENT_DATE END_DATE 
)
, CTE_REST as
(
...
--JJ GL Daily view
create or replace view IDH_{{params.env}}.D_FINANCE.GL_DAILY_SALES_MEASURE_JJ(
	BUSINESS_DATE,
	BRAND_ID,
	REST_ID,
	MEASURE_NAME,
