...
AND BRAND_ID='sonic' and FN_SYSTEM_ID in (7,8) ;
...
(
  ...
  (
    ...
    (
     ...
     WHERE fn_system_id IN ('7','8') AND dv.fiscal_week_end_dt BETWEEN
  ...
  (
   ...
   INNER JOIN "ids_{{params.source_env}}"."int_ref_bv"."date_dim_bv" dv ON fds.business_date = dv.calendar_dt
...
AND fwrm.brand_id = 'sonic'
AND fwrm.fn_system_id IN ('7','8')
