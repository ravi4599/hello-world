...
(
  WITH DATE_TO_BE_PROCESSED AS 
    (
	  ...
	  ON ss.business_date = dv.calendar_dt  WHERE ss.fn_system_id = '19' and ss.brand_id ='dnkn'
    ),
  ...
  FROM 
    ...
    WHERE fn_system_id = '19' AND fdss.brand_id = 'dnkn' AND dv.fiscal_week_end_dt BETWEEN
