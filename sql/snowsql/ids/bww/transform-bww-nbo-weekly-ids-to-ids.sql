...
--SET start_load_dt = '2023-04-01 / NULL';
--SET end_load_dt = '2023-04-20 / NULL';                 
...
(
 WITH DATE_TO_BE_PROCESSED AS
   (
	 ...
	 ON ss.business_date = dv.calendar_dt  WHERE ss.fn_system_id = '12' and ss.brand_id ='bww'
    ),
  ...
  WHERE fn_system_id = '12' AND fdss.brand_id='bww' AND dv.fiscal_week_end_dt BETWEEN
