...
(
  ...
  ON ss.business_date = dv.calendar_dt WHERE ss.fn_system_id = '11' AND ss.brand_id ='bww'
  ),
  ...
  FROM
    (
      ...
      WHERE fn_system_id = '11' AND fdss.brand_id = 'bww' AND dv.fiscal_week_end_dt BETWEEN
