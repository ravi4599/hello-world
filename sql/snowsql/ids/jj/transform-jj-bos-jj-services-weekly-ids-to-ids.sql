...
(
  WITH DATE_TO_BE_PROCESSED AS 
    (
	  ...
	  ON ss.business_date = dv.calendar_dt  WHERE ss.fn_system_id = '15' and ss.brand_id ='jj'
    ),
  ...
  FROM 
    ...
    WHERE fn_system_id = '15' AND fdss.brand_id = 'jj' AND dv.fiscal_week_end_dt BETWEEN
