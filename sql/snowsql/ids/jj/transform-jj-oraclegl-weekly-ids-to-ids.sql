...
--SET start_load_dt = '20230901 / NULL';
--SET end_load_dt = '20230925 / NULL';               
SET start_load_dt = '{{params.load_start_dt}}';   --Parameter from Airflow
...
(
  WITH DATE_TO_BE_PROCESSED AS 
    (
	  ...
	  ON ss.business_date = dv.calendar_dt  WHERE ss.fn_system_id = '16' and ss.brand_id ='jj'
    ),
  ...
  FROM 
    ...
    fdss.sale_usd_amount, fdss.sale_count, fdss.country_code, fdss.currency_code, 
    ...
    WHERE fn_system_id = '16' AND fdss.brand_id = 'jj' AND dv.fiscal_week_end_dt BETWEEN
