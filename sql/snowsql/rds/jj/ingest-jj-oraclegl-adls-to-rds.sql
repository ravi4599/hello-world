...
(
  ledger_name, posted_date, period, gl_date, batch_name, jeh_creation_date, jeh_created_by, jeh_name, je_source,
...
FROM
 (
  ...
  FROM @RDS_{{params.env}}.{{params.schema}}.SALES_RECON_JJ_CSV_ADLS2/OracleGL/
