...
4. Cleanup old SnowSQL scripts on remote host(s)
5. Copy [snowsql](./snowsql) folder to the rempote host(s) into `$HOME/snowsql/<REPOSITORY_NAME>/`
6. Cleanup SSH Private Key
