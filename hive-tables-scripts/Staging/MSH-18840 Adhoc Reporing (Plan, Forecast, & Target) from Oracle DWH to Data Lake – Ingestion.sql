...
lines terminated by '\n'
stored as textfile
location "s3://vv-staging-emr-cluster/data/landing/spf/hvtb_nbx_landing_spf_revenue_target_header"
;
...
lines terminated by '\n'
stored as textfile
location "s3://vv-staging-emr-cluster/data/landing/spf/hvtb_nbx_landing_spf_revenue_target_value"
;
...
lines terminated by '\n'
stored as textfile
location "s3://vv-staging-emr-cluster/data/landing/spf/hvtb_nbx_landing_spf_revenue_forecast_version"
;
